<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoGaleriSliderKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.VideoGaleriSliderKontrol" %>
<link href="../App_Themes/PendikMainTheme/Styles/SliderKontrol.css" rel="stylesheet"
      type="text/css" />
<script type="text/javascript">
    $().ready(function() {
        $('#VideoSlider').jcarousel({
            vertical: false,
            scroll: 3,
            auto: 0,
            animation: 400,
...
<asp:Repeater ID="RepeaterBannerSlider" runat="server">
    <HeaderTemplate>
        ...
        <ul id='VideoSlider' class='jcarousel-skin-video'>
    </HeaderTemplate>
    <ItemTemplate>
        <li>
        ...
        <li>
            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl='<%#Bind("Id") %>' OnDataBinding="HyperLink1_DataBinding">
                ...
                <div class="TumAlbumler">
                    <a href="videoalbumler/0/tumalbumler/1">Tüm Albümler</a>
                </div>
            </asp:HyperLink></li>
    </ItemTemplate>
    <FooterTemplate>
