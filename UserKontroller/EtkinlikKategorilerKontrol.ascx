<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EtkinlikKategorilerKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.EtkinlikKategorilerKontrol" %>
<div class="contentsidemodulemed">
    <div class="contentleftmenutext">
        <asp:Label ID="LabelBaslik" runat="server" Text="">Etkinlikler</asp:Label>
    </div>
