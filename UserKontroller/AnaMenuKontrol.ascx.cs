...
{
    public partial class AnaMenuKontrol : UserControl
    {
        ...
        public void AnaMenuler(Int32 UstMenuId, MenuItemCollection items)
        {
            ...
            var Menuler =
                Veriler.Menuler.Where(
                    p => p.MenuLokasyonId == 2 && p.MenudeGoster == true && p.Durum == true && p.DilId == DilId).OrderBy
                    (p => p.SiraNo).ToList();
            ...
            foreach (Menuler Menu in MList)
            {
                ...
                switch (Menu.MenuTipId)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        MItem.NavigateUrl = "/sayfa/" + Menu.Id + "/" + MenuUrl.MenuUrlDuzenle(Menu.MenuAdi);
                        break;
                }
                items.Add(MItem);
