<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EtkinliklerMansetKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.EtkinliklerMansetKontrol" %>
<script type="text/javascript">
    $(document).ready(function() {
        $("#EtkinlikManset").tabs({ fx: { opacity: "toggle" } }).tabs("rotate", 10000, true);
    });
</script>
<div id="EtkinlikManset">
...
<div class="allcontent">
    <a href="/etkinlikler/0/tumetkinlikler/1">Tüm Etkinlikler</a> • <a href="rsslistesi">
                                                                        RSS Listesi</a></div>