<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HaberlerMansetKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.HaberlerMansetKontrol" %>
<script type="text/javascript">
    $(document).ready(function() {
        $("#HaberManset").tabs({ fx: { opacity: "toggle" } }).tabs("rotate", 10000, true);
    });
</script>
<div id="HaberManset">
...
<div class="allcontent">
    <a href="/haberler/0/tumhaberler/1">Tüm Haberler</a> • <a href="rsslistesi">RSS Listesi</a></div>