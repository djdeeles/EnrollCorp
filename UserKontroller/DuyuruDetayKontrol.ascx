<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DuyuruDetayKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.DuyuruDetayKontrol" %>
    ...
    <div class="Images">
        <script type="text/javascript">
            function ResimDegistir(Resim) {
                document.getElementById('<%= ImageDuyuruGorsel.ClientID %>').src = "../../" + Resim;
            }
        </script>
        <div id='preview' style="width: 280px; height: 220px; overflow: hidden; padding-bottom: 3px;">
            <asp:Image ID="ImageDuyuruGorsel" runat="server" Width="280" />
        </div>
