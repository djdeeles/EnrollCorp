<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HaberKategorilerKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.HaberKategorilerKontrol" %>
<div class="contentsidemodulemed">
    <div class="contentleftmenutext">
        <asp:Label ID="LabelBaslik" runat="server" Text="">Haberler</asp:Label>
    </div>
