<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FotoAlbumDetayKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.FotoAlbumDetayKontrol" %>
...
<div class="contentmainbannertext">
    <div class="contentmainbannerbaslik">
        <asp:Label ID="LabelFotoAlbumKategoriAdi" runat="server" Text=""></asp:Label>
    </div>
        ...
        <% if (DataPager1.TotalRowCount > 19)
           { %>
            <asp:DataPager ID="DataPager1" runat="server" PagedControlID="ListView1" PageSize="20"
                           QueryStringField="fotoalbumdetaypage">
                <Fields>
