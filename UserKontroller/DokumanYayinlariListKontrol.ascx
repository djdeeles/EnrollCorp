<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DokumanYayinlariListKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.DokumanYayinlariListKontrol" %>
...
<div class="contentmainmed">
    ...
    <div id="gallery" style="height: 100%; width: 100%;">
        <div style="text-align: left;">
            <asp:Label ID="LabelKategoriAdi" runat="server" Font-Bold="true"></asp:Label></div>
        <br />
        ...
        <% if (DataPager1.TotalRowCount > 19)
           { %>
            <asp:DataPager ID="DataPager1" runat="server" PagedControlID="ListView1" PageSize="20"
                           QueryStringField="dokumanyayinlarilistpage">
                <Fields>
