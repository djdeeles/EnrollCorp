<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="YayinDetayKontrol.ascx.cs"
            Inherits="EnrollKurumsal.UserKontroller.YayinDetayKontrol" %>
...
<div class="contentmainbannertext">
    <div class="contentmainbannerbaslik">
        <asp:Label ID="LabelKategoriAdi" runat="server" Text=""></asp:Label>
    </div>
