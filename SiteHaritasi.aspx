<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
         CodeBehind="SiteHaritasi.aspx.cs" Inherits="EnrollKurumsal.SiteHaritasi" %>

<%@ Register Src="UserKontroller/SiteHaritasi.ascx" TagName="SiteHaritasi" TagPrefix="uc1" %>
            ...
            <tr>
                <td>
                    ...
                    <div class="contentmain">
                        <uc1:SiteHaritasi ID="SiteHaritasi1" runat="server" />
                    </div>
                </td>
            </tr>
        </table>
