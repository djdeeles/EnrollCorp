<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoAlbumKategorileriKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.VideoAlbumKategorileriKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxVideoAlbumKategoriAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxVideoAlbumKategoriAdi"
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="VideoAlbumKategoriAdi" HeaderText="Kategori Adı" SortExpression="VideoAlbumKategoriAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="VideoAlbumKategorileri"
