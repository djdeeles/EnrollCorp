<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BannerSliderKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.BannerSliderKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxBannerAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxBannerAdi"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <i>(240px X 110px boyutlarında resim ekleyiniz.) </i>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BannerAdi" HeaderText="Banner Adı" SortExpression="BannerAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="BannerSlider"
