<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GorevlerKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.GorevlerKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 550px;">
                                        <asp:DropDownList ID="DropDownListSablonlar" runat="server" Width="550px" OnSelectedIndexChanged="DropDownListSablonlar_SelectedIndexChanged"
                                                          AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TextBoxAciklama" runat="server" Rows="5" TextMode="MultiLine" Width="550px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadDateTimePicker ID="RadDateTimePickerBaslamaTarihi" runat="server" Culture="tr-TR">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="CheckBoxOkunduBilgisi" runat="server" Text="Evet" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="RadDateTimePickerBaslamaTarihi"
                                                                    Display="None" ErrorMessage="Başlama tarihi seçiniz." ForeColor="Red" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="BaslamaTarihi" HeaderText="Başlama Tarihi" SortExpression="BaslamaTarihi">
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="Gorevler">
