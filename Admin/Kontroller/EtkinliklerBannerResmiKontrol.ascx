<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EtkinliklerBannerResmiKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.EtkinliklerBannerResmiKontrol" %>
