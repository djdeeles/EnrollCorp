<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoAlbumlerKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.VideoAlbumlerKontrol" %>
                        ...
                        <td>
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxVideoAlbumAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxVideoAlbumAdi"
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="VideoAlbumAdi" HeaderText="Video Albüm Adı" SortExpression="VideoAlbumAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
