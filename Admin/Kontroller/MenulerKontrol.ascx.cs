        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                    ...
                    Convert.ToInt32(HttpContext.Current.User.Identity.Name), 3))
                {
                    ...
                    ImageButtonBannerGorseli.OnClientClick = "window.open('FileManager.aspx?ReturnField="
                                                             + TextBoxBannerGorsel.ClientID +
                                                             "','','width=640,height=480');";
                }
                else
                {
        ...
        private void UpdateMode(int Id)
        {
            ...
            switch (Menu.MenuTipId)
            {
                ...
                case 3:
                    ...
                    TextBoxBannerGorsel.Text = Menu.BannerGorsel;
            ...
            CheckBoxDurum.Checked = Menu.Durum.Value;
            CheckBoxMenudeGoster.Checked = Menu.MenudeGoster.Value;
            CheckBoxBasligiGoster.Checked = Menu.BasligiGöster.Value;
        }
            ...
            try
            {
                foreach (RadTreeNode Node in e.DraggedNodes)
                {
                    ...
                    if (MenuHedefId != 0)
                    {
                        ...
                        MenuHedefSiraNo = MenuHedef.SiraNo.Value;
                    }
                ...
                if (HiddenFieldEditMode.Value == "Insert")
                {
                    ...
                    switch (DropDownListTipler.SelectedValue)
                    {
                        ...
                        case "3":
                            ...
                            Menu.BannerGorsel = TextBoxBannerGorsel.Text;
                            break;
                    }
