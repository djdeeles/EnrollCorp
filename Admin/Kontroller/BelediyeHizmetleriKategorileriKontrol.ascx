<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BelediyeHizmetleriKategorileriKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.BelediyeHizmetleriKategorileriKontrol" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="BelediyeHizmetleriKategorileri"
