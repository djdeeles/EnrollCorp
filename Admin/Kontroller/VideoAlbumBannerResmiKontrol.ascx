<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoAlbumBannerResmiKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.VideoAlbumBannerResmiKontrol" %>
