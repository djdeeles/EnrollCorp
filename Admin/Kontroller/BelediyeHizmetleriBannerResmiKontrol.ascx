<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BelediyeHizmetleriBannerResmiKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.BelediyeHizmetleriBannerResmiKontrol" %>
