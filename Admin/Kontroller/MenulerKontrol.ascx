<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MenulerKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.MenulerKontrol" %>
                                        ...
                                        <asp:View ID="View2" runat="server">
                                            <table style="width: 550px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <i>( 775px x 125px boyutlarında resim giriniz. )</i>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TextBoxBannerGorsel" runat="server" Width="200px"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:ImageButton ID="ImageButtonBannerGorseli" runat="server" ImageUrl="../Theme/Images/icon/imaj_yukle_label.png" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
