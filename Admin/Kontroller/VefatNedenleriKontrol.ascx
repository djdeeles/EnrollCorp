<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VefatNedenleriKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.VefatNedenleriKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxVefatNedeni" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxVefatNedeni"
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="VefatNedeni" HeaderText="Vefat Nedeni" SortExpression="VefatNedeni">
                                            <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="VefatNedenleri">
