<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EtkinlikKategorileriKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.EtkinlikKategorileriKontrol" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="EtkinlikKategorileri"
