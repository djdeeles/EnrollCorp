<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DokumanYayinlariKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.DokumanYayinlariKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListDokumanKategorileri" runat="server" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownListDokumanKategorileri"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxDokumanAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBoxDokumanAdi"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;" colspan="2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:HyperLink ID="HyperLinkDokuman" runat="server" Target="_blank">Dokümanı Görüntüle</asp:HyperLink>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="TextBoxDokuman" runat="server" Width="400px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:ImageButton ID="ImageButtonDokuman" runat="server" ImageUrl="../Theme/Images/icon/dokuman_yukle_label.png" />
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBoxDokuman"
                                                                                Display="Dynamic" ErrorMessage="Gerekli" ForeColor="Red" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <table class="AnaTablo">
                        <tr>
                            <td style="text-align: right; width: 700px;">
                                Kategori :
                                <asp:DropDownList ID="DropDownListDokumanKategorileriGridView" runat="server" AutoPostBack="True"
                                                  OnSelectedIndexChanged="DropDownListDokumanKategorileriGridView_SelectedIndexChanged"
                                                  Width="250px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="DokumanAdi" HeaderText="Doküman Adı" SortExpression="DokumanAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
