<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IhalelerKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.IhalelerKontrol" %>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Ad" HeaderText="İhale Adı" SortExpression="Ad">
                                            <HeaderStyle HorizontalAlign="Left" />
