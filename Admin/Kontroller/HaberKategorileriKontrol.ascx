<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HaberKategorileriKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.HaberKategorileriKontrol" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="HaberKategorileri"
