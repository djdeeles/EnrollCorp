<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="YayinlarKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.YayinlarKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListYayinKategorileri" runat="server" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownListYayinKategorileri"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxYayinAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxYayinAdi"
                                    ...
                                    <td colspan="2">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBoxUrl"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="RadDateTimePickerTarih"
                                                                    ErrorMessage="Gerekli." ForeColor="Red" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <table class="AnaTablo">
                        <tr>
                            <td style="text-align: right; width: 700px;">
                                Kategori :
                                <asp:DropDownList ID="DropDownListYayinKategorileriGridView" runat="server" AutoPostBack="True"
                                                  OnSelectedIndexChanged="DropDownListVideoAlbumKategorileriGridView_SelectedIndexChanged"
                                                  Width="250px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="YayinAdi" HeaderText="Yayın Adı" SortExpression="YayinAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
