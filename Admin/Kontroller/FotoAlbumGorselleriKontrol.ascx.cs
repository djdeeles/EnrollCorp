// Consider changing variable name "FAG". It is unnecessarily offensive.
...
namespace EnrollKurumsal.Admin.Kontroller
{
    public partial class FotoAlbumGorselleriKontrol : UserControl
    {
        ...
        private void FotoAlbumleriVer(DropDownList DropDownList, ListItem Item, int FotoAlbumKategoriId)
        {
            int DilId = EnrollContext.Current.WorkingLanguage.languageId;
            var FA =
                Veriler.FotoAlbumler.Where(p => p.FotoAlbumKategoriId == FotoAlbumKategoriId && p.Durum == true).ToList();
            ...
            try
            {
                ...
                if (HiddenFieldId.Value != string.Empty)
                {
                    ...
                    DropDownListFotoAlbumKategorileriGridView.SelectedValue
                        =
                        Veriler.FotoAlbumler.Where(p => p.Id == FAG.FotoAlbumId).First().FotoAlbumKategoriId.Value.
                            ToString();
                    ...
                    DropDownListAlbumlerGridView.SelectedValue
                        = FAG.FotoAlbumId.Value.ToString();
                    EntityDataSource1.CommandText =
        ...
        private void Guncelle(FotoAlbumGorselleri FAG)
        {
            ...
            DropDownListAlbumler.SelectedValue = FAG.FotoAlbumId.Value.ToString();
            ...
            CheckBoxDurum.Checked = FAG.Durum.Value;
