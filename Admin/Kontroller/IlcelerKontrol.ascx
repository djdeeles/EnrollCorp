<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IlcelerKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.IlcelerKontrol" %>
                        ...
                        <td>
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListIller" runat="server" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 390px;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxIlceAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxIlceAdi"
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IlceAdi" HeaderText="İlçe Adı" SortExpression="IlceAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
