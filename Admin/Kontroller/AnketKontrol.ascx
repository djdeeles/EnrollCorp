<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AnketKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.AnketKontrol" %>
                    ...
                    <table class="AnaTablo">
                        <tr>
                            <td>
                                ...
                                <asp:EntityDataSource ID="EntityDataSourceAnketSorulari" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EntitySetName="AnketSorulari" Where="it.DilId=@DilId">
                                    <WhereParameters>
                                        <asp:CookieParameter CookieName="EnrollWorkingLanguage" Name="DilId" Type="Int32" />
                                    </WhereParameters>
                                </asp:EntityDataSource>
                                <asp:EntityDataSource ID="EntityDataSourceAnketCevaplari" runat="server" ConnectionString="name=EnrollKurumsalEntities"
