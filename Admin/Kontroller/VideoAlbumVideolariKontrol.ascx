<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VideoAlbumVideolariKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.VideoAlbumVideolariKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListVideoAlbumKategorileri" runat="server" Width="200px"
                                                          AutoPostBack="True" OnSelectedIndexChanged="DropDownListVideoAlbumKategorileri_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownListVideoAlbumKategorileri"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:DropDownList ID="DropDownListVideoAlbumler" runat="server" Width="200px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="DropDownListVideoAlbumler"
                                                                    Display="Dynamic" ErrorMessage="Gerekli." ForeColor="Red" InitialValue="0" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxVideoAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBoxVideoAdi"
                                    ...
                                    <td style="width: 200px;" colspan="2">
                                        <table>
                                            <tr>
                                                <td>
                                                    <div id="mediaplayer">
                                                        <asp:Label ID="LabelVideo" runat="server" Text=""></asp:Label></div>
                                                    <script src="Theme/VideoPlayer/jwplayer.js" type="text/javascript"></script>
                                                    <asp:Literal ID="LiteralVideo" runat="server"></asp:Literal>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="TextBoxVideo" runat="server" Width="400px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:ImageButton ID="ImageButtonVideo" runat="server" ImageUrl="../Theme/Images/icon/imaj_yukle_label.png" />
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBoxVideo"
                                                                                Display="Dynamic" ErrorMessage="Gerekli." ForeColor="Red" ValidationGroup="g1"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <table class="AnaTablo">
                        <tr>
                            <td style="text-align: right; width: 700px;">
                                Kategori :
                                <asp:DropDownList ID="DropDownListVideoAlbumKategorileriGridView" runat="server"
                                                  AutoPostBack="True" OnSelectedIndexChanged="DropDownListVideoAlbumKategorileriGridView_SelectedIndexChanged"
                                                  Width="250px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; width: 700px;">
                                Albüm :
                                <asp:DropDownList ID="DropDownListVideoAlbumlerGridView" runat="server" OnSelectedIndexChanged="DropDownListVideoAlbumlerGridView_SelectedIndexChanged"
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="100" HeaderText="Görsel" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Image ID="ImageGorsel" runat="server" ImageUrl='<%#Eval("Gorsel") %>' Width="100" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="VideoAdi" HeaderText="Video Adı" SortExpression="VideoAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
