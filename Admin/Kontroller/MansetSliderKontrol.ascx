<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MansetSliderKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.MansetSliderKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxMansetAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxMansetAdi"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <i>(535px X 205px boyutlarında resim ekleyiniz.) </i>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="MansetAdi" HeaderText="Manşet Adı" SortExpression="MansetAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="MansetSlider"
