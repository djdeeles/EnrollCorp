<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FotoAlbumBannerResmiKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.FotoAlbumBannerResmiKontrol" %>
