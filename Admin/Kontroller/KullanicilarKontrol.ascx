<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KullanicilarKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.KullanicilarKontrol" %>
                ...
                <asp:View ID="View2" runat="server">
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td style="height: 20px; color: White; background: #5D7B9D; padding-left: 5px; width: 100%;"
                                        colspan="4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBoxEPosta"
                                                                    ErrorMessage="Gerekli." ForeColor="Red" ValidationGroup="g" Display="Dynamic"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBoxEPosta"
                                                                        Display="Dynamic" ErrorMessage="Geçerli bir e-posta adresi giriniz." ForeColor="Red"
                                                                        ValidationGroup="g" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <asp:CheckBoxList ID="CheckBoxListRoller" runat="server">
                                        </asp:CheckBoxList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <asp:ImageButton ID="ImageButtonKaydet" runat="server" ImageUrl="../Theme/Images/kaydet.png"
                                                         OnClick="ImageButtonKaydet_Click" ValidationGroup="g" />
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridViewKullanicilar" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                              ...
                                              Width="700px" OnRowCommand="GridViewKullanicilar_RowCommand">
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="Kullanicilar"
                                                      Where="it.SilindiMi=False">
