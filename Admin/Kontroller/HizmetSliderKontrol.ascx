<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HizmetSliderKontrol.ascx.cs"
            Inherits="EnrollKurumsal.Admin.Kontroller.HizmetSliderKontrol" %>
                            ...
                            <table class="AnaTablo">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:TextBox ID="TextBoxHizmetAdi" runat="server" Width="200px"></asp:TextBox>
                                    </td>
                                    <td style="width: 390px;">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxHizmetAdi"
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <i>(175px X 100px boyutlarında resim ekleyiniz.) </i>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <td>
                                <asp:GridView ID="GridViewVeriler" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="HizmetAdi" HeaderText="Hizmet Adı" SortExpression="HizmetAdi">
                                            <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=EnrollKurumsalEntities"
                                                      DefaultContainerName="EnrollKurumsalEntities" EnableFlattening="False" EntitySetName="HizmetSlider"
