<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
         CodeBehind="HaberlerList.aspx.cs" Inherits="EnrollKurumsal.HaberlerList" %>

<%@ Register Src="UserKontroller/HaberlerListKontrol.ascx" TagName="HaberlerListKontrol"
             TagPrefix="uc1" %>
            ...
            <tr>
                <td>
                    ...
                    <div class="contentmain">
                        <uc1:HaberlerListKontrol ID="HaberlerListKontrol1" runat="server" />
                    </div>
                </td>
            </tr>
        </table>
