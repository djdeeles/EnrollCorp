<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
         CodeBehind="YayinlarList.aspx.cs" Inherits="EnrollKurumsal.YayinlarList" %>

<%@ Register Src="UserKontroller/YayinlarListKontrol.ascx" TagName="YayinlarListKontrol"
             TagPrefix="uc1" %>
            ...
            <tr>
                <td>
                    ...
                    <div class="contentmain">
                        <uc1:YayinlarListKontrol ID="YayinlarListKontrol1" runat="server" />
                    </div>
                </td>
            </tr>
        </table>
